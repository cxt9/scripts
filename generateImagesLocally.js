...
async function uploadToSupabase(imageId, base64Data) {
  ...
  const response = await fetch(
    `${SUPABASE_URL}/storage/v1/object/illustrations/${storagePath}`,
    {
      method: 'POST',
      headers: {
  ...
  const publicUrl = `${SUPABASE_URL}/storage/v1/object/public/illustrations/${storagePath}`;
  return publicUrl;
}
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════════╗');
  console.log('║         Generating Illustrations with Gemini                   ║');
  console.log('╚════════════════════════════════════════════════════════════════╝');
